...
int main()
{
    ...
    F.SetCarSeparatore(';');
    F.CancellaFile();
    F.AggiungiRiga("data odierna;ora;temp");
    F.AggiungiRiga("1/1/2021;8:47;23");
    F.AggiungiRiga("2/1/2021;8:50;25");
    F.AggiungiRiga("CIAO;125;10:23;GIOVEDI");

    nC = F.LeggiPrimaRigaGets(stringa);
    ...
    cout << "0 - " << campi[0].carattere << " 1 - " << campi[1].carattere << " 2 - " << campi[2].carattere << endl;
